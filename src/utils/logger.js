...
module.exports = function (options) {
  ...
  if(options&&options.transports.file.enabled) {
  	logger.add(winston.transports.File, {name: 'user-data-api-info', 	colorize: true, level: 'info', 	filename: options.transports.file.server.info});
  	logger.add(winston.transports.File, {name: 'user-data-api-error', colorize: true, level: 'error', filename: options.transports.file.server.error, handleExceptions: true});
    logger.add(winston.transports.File, {name: 'user-data-api-debug', colorize: true, level: 'debug', filename: options.transports.file.server.debug});
  }
