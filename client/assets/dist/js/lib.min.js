...
Vel = $ ? $.Velocity : Velocity, function($) {
    $.fn.collapsible = function(options) {
        ...
        return options = $.extend(defaults, options), this.each(function() {
            ...
            $this.on("click.collapse", "> li > .collapsible-header", function(e) {
                var $header = $(this), element = $(e.target);
    ...
    $.fn.scrollTo = function(elem) {
        ...
        this.each(function() {
            ...
            function placeDropdown(eventType) {
                ...
                var gutterSpacing, windowHeight = window.innerHeight, originHeight = origin.innerHeight(), offsetLeft = origin.offset().left, offsetTop = origin.offset().top - $(window).scrollTop(), currAlignment = options.alignment, verticalOffset = 0;
                if (options.belowOrigin === !0 && (verticalOffset = originHeight), offsetLeft + activates.innerWidth() > $(window).width() ? currAlignment = "right" : offsetLeft - activates.innerWidth() + origin.innerWidth() < 0 && (currAlignment = "left"), 
            ...
            function hideDropdown() {
                ...
                activates.css("max-height", ""), origin.removeClass("active");
            }
            var origin = $(this), options = $.extend({}, defaults, option), isFocused = !1, activates = $("#" + origin.attr("data-activates"));
            if (updateOptions(), origin.after(activates), options.hover) {
                ...
                placeDropdown("click")), activates.hasClass("active") && $(document).bind("click." + activates.attr("id") + " touchstart." + activates.attr("id"), function(e) {
                ...
                $("#materialbox-overlay").velocity({
                    ...
                    complete: function() {
                        placeholder.css({
                            ...
                            position: "",
                            "z-index": ""
                        }), origin.removeClass("active"), doneAnimating = !0, $(this).remove(), ancestorsChanged.css("overflow", "");
                    }
                });
            }
            if (!$(this).hasClass("initialized")) {
                $(this).addClass("initialized");
                var ancestorsChanged, ancestor, overlayActive = !1, doneAnimating = !0, inDuration = 275, outDuration = 200, origin = $(this), placeholder = $("<div></div>").addClass("material-placeholder");
                origin.wrap(placeholder), origin.on("click", function() {
                    ...
                    for (;null !== ancestor && !$(ancestor).is(document); ) {
                        var curr = $(ancestor);
                        "hidden" === curr.css("overflow") && (curr.css("overflow", "visible"), ancestorsChanged = void 0 === ancestorsChanged ? curr : ancestorsChanged.add(curr)), 
    ...
    var methods = {
        init: function() {
            return this.each(function() {
                ...
                $(window).width();
                $this.width("100%");
                var $active, $content, $links = $this.find("li.tab a"), $tabs_width = $this.width(), $tab_width = $this.find("li").first().outerWidth(), $tab_min_width = parseInt($this.find("li").first().css("minWidth")), $index = 0;
                ...
                if ($this.is(":visible") && ($indicator.css({
                ...
                }), $tab_min_width >= $tab_width) {
                    $this.wrap('<div class="hide-tab-scrollbar"></div>');
                    var scrollDiv = document.createElement("div");
                    scrollDiv.className = "scrollbar-measure", document.body.appendChild(scrollDiv);
                    var scrollbarHeight = scrollDiv.offsetHeight - scrollDiv.clientHeight;
                    document.body.removeChild(scrollDiv), 0 === scrollbarHeight && (scrollbarHeight = 15, 
                    $this.find(".indicator").css("bottom", scrollbarHeight)), $this.height($(this).height() + scrollbarHeight);
                }
            });
        },
    ...
    $.fn.tooltip = function(options) {
        ...
        return "remove" === options ? (this.each(function() {
        ...
        }), !1) : (options = $.extend(defaults, options), this.each(function() {
            var tooltipId = Materialize.guid(), origin = $(this);
            origin.attr("data-tooltip-id", tooltipId);
            var tooltip_text = $("<span></span>").text(origin.attr("data-tooltip")), newTooltip = $("<div></div>");
            ...
            backdrop.appendTo(newTooltip), backdrop.css({
                top: 0,
                left: 0
            }), origin.off("mouseenter.tooltip mouseleave.tooltip"), origin.on({
    ...
    var repositionWithinScreen = function(x, y, width, height) {
        ...
        0 > newY ? newY = 4 : newY + height > window.innerHeight + $(window).scrollTop && (newY -= newY + height - window.innerHeight), 
        {
            x: newX,
            y: newY
        };
    ...
    function createToast(html) {
        ...
        ("object" == typeof HTMLElement ? html instanceof HTMLElement : html && "object" == typeof html && null !== html && 1 === html.nodeType && "string" == typeof html.nodeName) ? toast.appendChild(html) : html instanceof jQuery ? toast.appendChild(html[0]) : toast.innerHTML = html;
    ...
    var methods = {
        init: function(options) {
            ...
            options = $.extend(defaults, options), $(this).each(function() {
                ...
                240 != options.menuWidth && menu_id.css("width", options.menuWidth);
                var dragTarget = $('<div class="drag-target"></div>');
                $("body").append(dragTarget), "left" == options.edge ? (menu_id.css("left", -1 * (options.menuWidth + 10)), 
                dragTarget.css({
                    left: 0
                ...
                dragTarget.on("click", function() {
                    ...
                    if (menuOut === !0) menuOut = !1, panning = !1, removeMenu(); else {
                        $("body").css("overflow", "hidden"), $("body").append(dragTarget), "left" === options.edge ? (dragTarget.css({
                            width: "50%",
                            right: 0,
                            left: ""
                        }), menu_id.velocity({
    ...
    $(document).ready(function() {
        ...
        Materialize.updateTextFields = function() {
            ...
            $(input_selector).each(function(index, element) {
                $(element).val().length > 0 || void 0 !== $(this).attr("placeholder") || $(element)[0].validity.badInput === !0 ? $(this).siblings("label").addClass("active") : $(this).siblings("label, i").removeClass("active");
            });
        };
        var input_selector = "input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], textarea";
        ...
        $(text_area_selector).each(function() {
            ...
            for (var file_field = $(this).closest(".file-field"), path_input = file_field.find("input.file-path"), files = $(this)[0].files, file_names = [], i = 0; i < files.length; i++) file_names.push(files[i].name);
        ...
        $(document).on("change", range_type, function(e) {
            ...
            $(this).addClass("active"), thumb.hasClass("active") || thumb.velocity({
                ...
                duration: 300,
                easing: "easeOutExpo"
            }), "input" !== e.type && (left = void 0 === e.pageX || null === e.pageX ? e.originalEvent.touches[0].pageX - $(this).offset().left : e.pageX - $(this).offset().left, 
        ...
        function toggleEntryFromArray(entriesArray, entryIndex, select) {
            ...
            -1 === index ? entriesArray.push(entryIndex) : entriesArray.splice(index, 1), select.siblings("ul.dropdown-content").find("li").eq(entryIndex).toggleClass("active"), 
            select.find("option").eq(entryIndex).prop("selected", !0), setValueToInput(entriesArray, select);
        }
        ...
        $(this).each(function() {
            ...
            if (!$select.hasClass("browser-default")) {
                ...
                var options = $('<ul id="select-options-' + uniqueID + '" class="dropdown-content select-dropdown ' + (multiple ? "multiple-select-dropdown" : "") + '"></ul>'), selectOptions = $select.children("option"), selectOptGroups = $select.children("optgroup"), valuesSelected = [], optionsHover = !1;
                $select.find("option:selected").length > 0 ? label = $select.find("option:selected") : label = selectOptions.first();
                var appendOptionWithIcon = function(select, option, type) {
                    var disabledClass = option.is(":disabled") ? "disabled " : "", icon_url = option.data("icon"), classes = option.attr("class");
                    if (icon_url) {
                        var classString = "";
                        return classes && (classString = ' class="' + classes + '"'), "multiple" === type ? options.append($('<li class="' + disabledClass + '"><img src="' + icon_url + '"' + classString + '><span><input type="checkbox"' + disabledClass + "/><label></label>" + option.html() + "</span></li>")) : options.append($('<li class="' + disabledClass + '"><img src="' + icon_url + '"' + classString + "><span>" + option.html() + "</span></li>")), 
                        !0;
                    }
                    "multiple" === type ? options.append($('<li class="' + disabledClass + '"><span><input type="checkbox"' + disabledClass + "/><label></label>" + option.html() + "</span></li>")) : options.append($('<li class="' + disabledClass + '"><span>' + option.html() + "</span></li>"));
                };
                selectOptGroups.length ? selectOptGroups.each(function() {
                    selectOptions = $(this).children("option"), options.append($('<li class="optgroup"><span>' + $(this).attr("label") + "</span></li>")), 
                    selectOptions.each(function() {
                        appendOptionWithIcon($select, $(this));
                    });
                }) : selectOptions.each(function() {
                    $(this).is(":disabled") ? "disabled " : "";
                    multiple ? appendOptionWithIcon($select, $(this), "multiple") : appendOptionWithIcon($select, $(this));
                }), options.find("li:not(.optgroup)").each(function(i) {
                    var $curr_select = $select;
                    $(this).click(function(e) {
                        $(this).hasClass("disabled") || $(this).hasClass("optgroup") || (multiple ? ($('input[type="checkbox"]', this).prop("checked", function(i, v) {
                            return !v;
                        }), toggleEntryFromArray(valuesSelected, $(this).index(), $curr_select), $newSelect.trigger("focus")) : (options.find("li").removeClass("active"), 
                        $(this).toggleClass("active"), $curr_select.siblings("input.select-dropdown").val($(this).text())), 
                        activateOption(options, $(this)), $curr_select.find("option").eq(i).prop("selected", !0), 
                        $curr_select.trigger("change"), "undefined" != typeof callback && callback()), e.stopPropagation();
                    });
                }), $select.wrap(wrapper);
                var dropdownIcon = $('<span class="caret">&#9660;</span>');
                $select.is(":disabled") && dropdownIcon.addClass("disabled");
                var sanitizedLabelHtml = label.html() && label.html().replace(/"/g, "&quot;"), $newSelect = $('<input type="text" class="select-dropdown" readonly="true" ' + ($select.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + uniqueID + '" value="' + sanitizedLabelHtml + '"/>');
                ...
                $select.addClass("initialized"), $newSelect.on({
                    focus: function() {
                        ...
                        !options.is(":visible")) {
                            ...
                            var label = $(this).val(), selectedOption = options.find("li").filter(function() {
                    ...
                    collection.find("li.selected").removeClass("selected"), $(newOption).addClass("selected");
                };
    ...
    $(document).ready(function() {
        $(document).on("click.card", ".card", function(e) {
            ...
            }) : ($(e.target).is($(".card .activator")) || $(e.target).is($(".card .activator i"))) && ($(e.target).closest(".card").css("overflow", "hidden"), 
    ...
    $(document).ready(function() {
        $.fn.reverse = [].reverse, $(document).on("mouseenter.fixedActionBtn", ".fixed-action-btn:not(.click-to-toggle)", function(e) {
            var $this = $(this);
            openFABMenu($this);
            ...
            var $this = $(this), $menu = $this.parent();
...
Vel = $ ? $.Velocity : Velocity, function(a) {
    ...
    a.fn.scrollTo = function(b) {
        ...
        this.each(function() {
            ...
            function e(b) {
                ...
                if (h.belowOrigin === !0 && (n = f), k + j.innerWidth() > a(window).width() ? m = "right" : k - j.innerWidth() + g.innerWidth() < 0 && (m = "left"), 
            ...
            function f() {
                i = !1, j.fadeOut(h.outDuration), j.removeClass("active"), j.css("max-height", ""), 
                ...
                "mouseenter.tooltip": function() {
                    ...
                    a = void 0 === a || "" === a ? c.delay : a, d = 0, f = setInterval(function() {
                        if (d += 10, d >= a && e === !1) {
                            ...
                            "top" === n ? (c = i.offset().top - o - g, f = i.offset().left + j / 2 - p / 2, 
                            h = b(f, c, p, o), q = "-10px", l.css({
                                borderRadius: "14px 14px 0 0",
                                transformOrigin: "50% 90%",
                                marginTop: o,
                                marginLeft: p / 2 - l.width() / 2
                            })) : "left" === n ? (c = i.offset().top + m / 2 - o / 2, f = i.offset().left - p - g, 
                            h = b(f, c, p, o), r = "-10px", l.css({
                                width: "14px",
                                height: "14px",
                                borderRadius: "14px 0 0 14px",
                                transformOrigin: "95% 50%",
                                marginTop: o / 2,
                                marginLeft: p
                            })) : "right" === n ? (c = i.offset().top + m / 2 - o / 2, f = i.offset().left + j + g, 
                            h = b(f, c, p, o), r = "+10px", l.css({
                                width: "14px",
                                height: "14px",
                                borderRadius: "0 14px 14px 0",
                                ...
                                marginTop: o / 2,
                                marginLeft: "0px"
                            })) : (c = i.offset().top + i.outerHeight() + g, f = i.offset().left + j / 2 - p / 2, 
                            h = b(f, c, p, o), q = "+10px", l.css({
                                marginLeft: p / 2 - l.width() / 2
                            })), k.css({
                                top: h.y,
        ...
        a(this).each(function() {
            ...
            if (!d.hasClass("browser-default")) {
                ...
                var n = function(b, c, d) {
                    ...
                    if (f) {
                        var h = "";
                        return g && (h = ' class="' + g + '"'), i.append(a("multiple" === d ? '<li class="' + e + '"><img src="' + f + '"' + h + '><span><input type="checkbox"' + e + "/><label></label>" + c.html() + "</span></li>" : '<li class="' + e + '"><img src="' + f + '"' + h + "><span>" + c.html() + "</span></li>")), 
                        !0;
                    }
                ...
                k.length ? k.each(function() {
                    j = a(this).children("option"), i.append(a('<li class="optgroup"><span>' + a(this).attr("label") + "</span></li>")), 
                    j.each(function() {
                        n(d, a(this));
                    });
                }) : j.each(function() {
                    a(this).is(":disabled") ? "disabled " : "", e ? n(d, a(this), "multiple") : n(d, a(this));
                    ...
                    a(this).click(function(d) {
                        a(this).hasClass("disabled") || a(this).hasClass("optgroup") || (e ? (a('input[type="checkbox"]', this).prop("checked", function(a, b) {
                            return !b;
                        }), c(l, a(this).index(), g), q.trigger("focus")) : (i.find("li").removeClass("active"), 
                        a(this).toggleClass("active"), g.siblings("input.select-dropdown").val(a(this).text())), 
                        activateOption(i, a(this)), g.find("option").eq(f).prop("selected", !0), g.trigger("change"), 
                ...
                var r = [], s = function(b) {
                    ...
                    if (13 != b.which || i.is(":visible")) {
                        ...
                        activateOption(i, g)), 27 == b.which && q.trigger("close"), 38 == b.which && (g = i.find("li.selected").prev("li:not(.disabled)")[0], 
                        g && activateOption(i, g)), setTimeout(function() {
                            r = [];
                        }, 1e3);
                    }
                };
    ...
    var b = {
        init: function(b) {
            ...
            return b = a.extend(c, b), this.each(function() {
                ...
                -1 != k && (e = j.eq(k)), h.hasClass("fullscreen") || (h.height(b.indicators ? b.height + 40 : b.height), 
    ...
    function offset(elem) {
        var rect = elem.getBoundingClientRect(), doc = elem.ownerDocument, docElem = doc.documentElement, pageOffset = getPageOffset();
    ...
    function testBehaviour(parsed, entry) {
        ...
        var tap = entry.indexOf("tap") >= 0, drag = entry.indexOf("drag") >= 0, fixed = entry.indexOf("fixed") >= 0, snap = entry.indexOf("snap") >= 0, hover = entry.indexOf("hover") >= 0;
        if (drag && !parsed.connect) throw new Error("noUiSlider: 'drag' behaviour must be used with 'connect': true.");
        parsed.events = {
            tap: tap || snap,
            drag: drag,
            fixed: fixed,
    ...
    function testTooltips(parsed, entry) {
        var i;
        if (entry !== !1) if (entry === !0) for (parsed.tooltips = [], i = 0; i < parsed.handles; i++) parsed.tooltips.push(!0); else {
            if (parsed.tooltips = asArray(entry), parsed.tooltips.length !== parsed.handles) throw new Error("noUiSlider: must pass a formatter for all handles.");
            parsed.tooltips.forEach(function(formatter) {
                if ("boolean" != typeof formatter && ("object" != typeof formatter || "function" != typeof formatter.to)) throw new Error("noUiSlider: 'tooltips' must be passed a formatter or 'false'.");
            });
        }
    }
    ...
    function testCssPrefix(parsed, entry) {
        if (void 0 !== entry && "string" != typeof entry) throw new Error("noUiSlider: 'cssPrefix' must be a string.");
    ...
    function testOptions(options) {
        ...
        return Object.keys(tests).forEach(function(name) {
    ...
    function closure(target, options) {
        ...
        function fixEvent(e, pageOffset) {
            ...
            y = e.changedTouches[0].pageY), pageOffset = pageOffset || getPageOffset(), (mouse || pointer) && (x = e.clientX + pageOffset.x, 
            y = e.clientY + pageOffset.y), event.pageOffset = pageOffset, event.points = [ x, y ], 
            event.cursor = mouse || pointer, event;
        }
        function addHandle(direction, index) {
            var origin = document.createElement("div"), handle = document.createElement("div"), additions = [ "-lower", "-upper" ];
            return direction && additions.reverse(), addClass(handle, cssClasses[3]), addClass(handle, cssClasses[3] + additions[index]), 
            addClass(origin, cssClasses[2]), origin.appendChild(handle), origin;
        }
        function addConnection(connect, target, handles) {
            switch (connect) {
              case 1:
                addClass(target, cssClasses[7]), addClass(handles[0], cssClasses[6]);
                break;
        ...
        function addSlider(direction, orientation, target) {
            addClass(target, cssClasses[0]), addClass(target, cssClasses[8 + direction]), addClass(target, cssClasses[4 + orientation]);
            var div = document.createElement("div");
            return addClass(div, cssClasses[1]), target.appendChild(div), div;
        }
        function addTooltip(handle, index) {
            if (!options.tooltips[index]) return !1;
            var element = document.createElement("div");
            return element.className = cssClasses[18], handle.firstChild.appendChild(element);
        }
        function tooltips() {
            options.dir && options.tooltips.reverse();
            var tips = scope_Handles.map(addTooltip);
            options.dir && (tips.reverse(), options.tooltips.reverse()), bindEvent("update", function(f, o, r) {
                tips[o] && (tips[o].innerHTML = options.tooltips[o] === !0 ? f[o] : options.tooltips[o].to(r[o]));
            });
        }
        ...
        function generateSpread(density, mode, group) {
            ...
            group.forEach(function(current, index) {
                ...
                low !== !1 && void 0 !== high) for (i = low; high >= i; i = safeIncrement(i, step)) {
        ...
        function addMarking(spread, filterFunc, formatter) {
            ...
            function addSpread(offset, values) {
                ...
                values[1] && (element.innerHTML += "<div " + getTags(offset, cssClasses[22], values) + ">" + formatter.to(values[0]) + "</div>");
            }
            var style = [ "horizontal", "vertical" ][options.ort], element = document.createElement("div");
            return addClass(element, cssClasses[20]), addClass(element, cssClasses[20] + "-" + style), 
        ...
        function fireEvent(event, handleNumber, tap) {
            void 0 !== handleNumber && 1 !== options.handles && (handleNumber = Math.abs(handleNumber - options.dir)), 
            Object.keys(scope_Events).forEach(function(targetEvent) {
                var eventType = targetEvent.split(".")[0];
                event === eventType && scope_Events[targetEvent].forEach(function(callback) {
                    callback.call(scope_Self, asArray(valueGet()), handleNumber, asArray(inSliderOrder(Array.prototype.slice.call(scope_Values))), tap || !1);
                });
            });
        }
        ...
        function attach(events, element, callback, data) {
            var method = function(e) {
                return scope_Target.hasAttribute("disabled") ? !1 : hasClass(scope_Target, cssClasses[14]) ? !1 : (e = fixEvent(e, data.pageOffset), 
                events === actions.start && void 0 !== e.buttons && e.buttons > 1 ? !1 : data.hover && e.buttons ? !1 : (e.calcPoint = e.points[options.ort], 
        ...
        function move(event, data) {
            if (-1 === navigator.appVersion.indexOf("MSIE 9") && 0 === event.buttons && 0 !== data.buttonsProperty) return end(event, data);
            var positions, i, handles = data.handles || scope_Handles, state = !1, proposal = 100 * (event.calcPoint - data.start) / data.baseSize, handleNumber = handles[0] === scope_Handles[0] ? 0 : 1;
        ...
        function end(event, data) {
            var active = scope_Base.querySelector("." + cssClasses[15]), handleNumber = data.handles[0] === scope_Handles[0] ? 0 : 1;
            null !== active && removeClass(active, cssClasses[15]), event.cursor && (document.body.style.cursor = "", 
            document.body.removeEventListener("selectstart", document.body.noUiListener));
            var d = document.documentElement;
            d.noUiListeners.forEach(function(c) {
                d.removeEventListener(c[0], c[1]);
            }), removeClass(scope_Target, cssClasses[12]), fireEvent("set", handleNumber), fireEvent("change", handleNumber), 
            void 0 !== data.handleNumber && fireEvent("end", data.handleNumber);
        }
        function documentLeave(event, data) {
            "mouseout" === event.type && "HTML" === event.target.nodeName && null === event.relatedTarget && end(event, data);
        }
        function start(event, data) {
            var d = document.documentElement;
            if (1 === data.handles.length && (addClass(data.handles[0].children[0], cssClasses[15]), 
            ...
            if (d.noUiListeners = moveEvent.concat(endEvent, outEvent), event.cursor) {
                document.body.style.cursor = getComputedStyle(event.target).cursor, scope_Handles.length > 1 && addClass(scope_Target, cssClasses[12]);
                var f = function() {
                    return !1;
                };
        ...
        function tap(event) {
            ...
            to = 100 * location / baseSize(), options.events.snap || addClassFor(scope_Target, cssClasses[14], 300), 
            scope_Handles[handleNumber].hasAttribute("disabled") ? !1 : (setHandle(scope_Handles[handleNumber], to), 
            fireEvent("slide", handleNumber, !0), fireEvent("set", handleNumber, !0), fireEvent("change", handleNumber, !0), 
            void (options.events.snap && start(event, {
                handles: [ scope_Handles[handleNumber] ]
            })));
        }
        function hover(event) {
            var location = event.calcPoint - offset(scope_Base)[options.style], to = scope_Spectrum.getStep(100 * location / baseSize()), value = scope_Spectrum.fromStepping(to);
            Object.keys(scope_Events).forEach(function(targetEvent) {
        ...
        function events(behaviour) {
            ...
            if (behaviour.tap && attach(actions.start, scope_Base, tap, {
                handles: scope_Handles
            }), behaviour.hover) for (attach(actions.move, scope_Base, hover, {
                hover: !0
            }), i = 0; i < scope_Handles.length; i += 1) [ "mousemove MSPointerMove pointermove" ].forEach(function(eventName) {
                scope_Handles[i].children[0].addEventListener(eventName, stopPropagation, !1);
            });
            behaviour.drag && (drag = [ scope_Base.querySelector("." + cssClasses[7]) ], addClass(drag[0], cssClasses[10]), 
        ...
        function setHandle(handle, to, noLimitOption) {
            ...
            to = scope_Spectrum.getStep(to), to = limit(parseFloat(to.toFixed(7))), to === scope_Locations[trigger] ? !1 : (window.requestAnimationFrame ? window.requestAnimationFrame(function() {
                handle.style[options.style] = to + "%";
            }) : handle.style[options.style] = to + "%", handle.previousSibling || (removeClass(handle, cssClasses[17]), 
            to > 50 && addClass(handle, cssClasses[17])), scope_Locations[trigger] = to, scope_Values[trigger] = scope_Spectrum.fromStepping(to), 
        ...
        function valueSet(input) {
            ...
            for (options.dir && options.handles > 1 && values.reverse(), options.animate && -1 !== scope_Locations[0] && addClassFor(scope_Target, cssClasses[14], 300), 
        ...
        function updateOptions(optionsToUpdate) {
            var i, v = valueGet(), newOptions = testOptions({
                start: [ 0, 0 ],
                ...
                snap: void 0 === optionsToUpdate.snap ? options.snap : optionsToUpdate.snap
            });
            for ([ "margin", "limit", "step", "range", "animate" ].forEach(function(name) {
                void 0 !== optionsToUpdate[name] && (options[name] = optionsToUpdate[name]);
            }), scope_Spectrum = newOptions.spectrum, scope_Locations = [ -1, -1 ], valueSet(v), 
            i = 0; i < scope_Handles.length; i++) fireEvent("update", i);
        }
        var scope_Base, scope_Handles, scope_Self, scope_Target = target, scope_Locations = [ -1, -1 ], scope_Spectrum = options.spectrum, scope_Values = [], scope_Events = {}, cssClasses = [ "target", "base", "origin", "handle", "horizontal", "vertical", "background", "connect", "ltr", "rtl", "draggable", "", "state-drag", "", "state-tap", "active", "", "stacking", "tooltip", "", "pips", "marker", "value" ].map(addCssPrefix(options.cssPrefix || defaultCssPrefix));
        ...
        addConnection(options.connect, scope_Target, scope_Handles), options.pips && pips(options.pips), 
        options.tooltips && tooltips(), scope_Self = {
            destroy: destroy,
        ...
        }, events(options.events), scope_Self;
    }
